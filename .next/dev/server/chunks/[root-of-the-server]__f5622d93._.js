...
async function POST(request) {
    try {
        ...
        const userCount = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments();
        if (userCount === 0) {
            const hashedAdminPassword = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hash('123456', 10);
        ...
        if (!user) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'משתמש לא נמצא. בדוק את כתובת המייל.'
            }, {
                status: 401
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f5622d93._.js.map