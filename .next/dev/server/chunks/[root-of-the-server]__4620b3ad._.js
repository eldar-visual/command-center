...
"[project]/app/api/spaces/[id]/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request, { params }) {
    ...
    if (id === 'default') {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Cannot update default space'
        });
    }
    try {
        const body = await request.json();
        const updatedSpace = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Space$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(id, body, {
            new: true
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(updatedSpace);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4620b3ad._.js.map